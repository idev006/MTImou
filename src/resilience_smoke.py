...
def main() -> int:
    ...
    cycles = parse_env_int("IMOU_RESILIENCE_CYCLES", 3)
    sleep_sec = parse_env_float("IMOU_RESILIENCE_SLEEP_SEC", 1.5)
    tcp_timeout = parse_env_float("IMOU_HEALTH_TCP_TIMEOUT_SEC", 2.0)
    frame_timeout = parse_env_float("IMOU_HEALTH_FRAME_TIMEOUT_SEC", 5.0)
