...
class ControlPanelWindow(ControlPanelStateMixin, ControlPanelActionsMixin, QMainWindow):
    ...
    def _build_dashboard_tab(self) -> QWidget:
        ...
        button_specs = [
            ...
            ("Copy LAN RTSP", self.copy_selected_lan_stream_urls, False),
            ("Copy Public RTSP (Main)", self.copy_selected_public_main_stream_urls, False),
            ("Copy DDNS RTSP (Main)", self.copy_selected_ddns_main_stream_urls, False),
            ("Copy Public RTSP (Substream)", self.copy_selected_public_substream_urls, False),
            ("Copy DDNS RTSP (Substream)", self.copy_selected_ddns_substream_urls, False),
