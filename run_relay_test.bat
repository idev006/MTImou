...
if "%IMOU_CAMERA_TYPE%"=="" set "IMOU_CAMERA_TYPE=0"
if "%IMOU_FORCE_RELAY%"=="" set "IMOU_FORCE_RELAY=1"
if "%IMOU_RTSP_INCLUDE_AUTH%"=="" set "IMOU_RTSP_INCLUDE_AUTH=1"
if "%IMOU_RTSP_TRY_ANON%"=="" set "IMOU_RTSP_TRY_ANON=0"
if "%IMOU_USE_FFPROBE%"=="" set "IMOU_USE_FFPROBE=0"
if "%IMOU_ONE_URL_PER_TUNNEL%"=="" set "IMOU_ONE_URL_PER_TUNNEL=1"
...
echo [INFO] Running relay stream test...
"%PYTHON_EXE%" -u src\relay_stream_test.py
set "RC=%ERRORLEVEL%"
